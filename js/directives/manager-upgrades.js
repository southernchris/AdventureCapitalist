    angular.module('adventureApp').directive('managerUpgrades', function () {       
        return {
            ...
            link : function ($scope) {
                $scope.isEarth = function (planet)
                {
                    return planet === "earth";
                },
                $scope.isMoon = function (planet)
                {
                    return planet === "moon";
                },
            ...
            template: `
            <button ng-click="setPlanet('moon')">Click Me</button>
            <p>{{planet}}</p>
<table class="table table-striped table-hover table-bordered">
<thead>
    <tr>
    <th>Business</th>
    <th data-ng-show="isEarth(planet)"><label>10% off</label></th>
    <th data-ng-show="isEarth(planet)"><label>99.999% off</label></th>
    <th data-ng-show="isMoon(planet)"><label>25% off</label></th>
    </tr>
</thead>
<tbody>
